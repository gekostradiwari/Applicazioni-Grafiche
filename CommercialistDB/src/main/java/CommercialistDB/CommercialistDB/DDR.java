...
public class DDR extends Adempimento {
	...
	public DDR(String codiceID, String descrizione, double prezzo, String dataScadenza, String dataInvio,double detrazioni,double redditodafabbricati,double reddito) {
